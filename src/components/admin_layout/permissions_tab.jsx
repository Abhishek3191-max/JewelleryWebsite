...
//   try {
//     const response = await fetch(`${BASE_URL}${API_PREFIX}/get-type-of-permission`, {
//       method: 'GET',
//       headers: getHeaders()
//     });
...
//     const response = await fetch(`${BASE_URL}${API_PREFIX}/assign-permission-to-role?roleId=${numericRoleId}&permissionId=${numericPermissionId}`, {
//       method: 'GET',
//       headers: getHeaders()
//     });
...
//     const response = await fetch(`${BASE_URL}${API_PREFIX}/remove-permission-from-role?roleId=${numericRoleId}&permissionId=${numericPermissionId}`, {
//       method: 'GET',
//       headers: getHeaders()
//     });
...
//   try {
//     const response = await fetch(`${BASE_URL}${API_PREFIX}/get-role-permission`, {
//       method: 'GET',
//       headers: getHeaders()
//     });
...
//       await removePermissionMutation.mutateAsync(values);
//     }
//   });
...
//                     onChange={(e) => {
//                       console.log('Selected role value (remove):', e.target.value);
...
//                   disabled={!removeFormik.isValid || removeFormik.isSubmitting || removePermissionMutation.isPending}
//                 >
...
const fetchRolePermissionsByRoleId = async (roleId) => {
  try {
    const response = await fetch(`${BASE_URL}${API_PREFIX}/get-role-permission?roleId=${roleId}`, {
      method: 'GET',
      headers: getHeaders()
    });
